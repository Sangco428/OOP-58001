...
Ent1 = Entry(window, bd=2, justify="center", fg="red")
Ent1.grid(row=0, column=0)
Ent1.insert(0, "row 0, column 0")

Ent2 = Entry(window, bd=2, justify="center", fg="yellow")
...
Ent5 = Entry(window, bd=2, justify="center", fg="yellow")
Ent5.grid(row=1, column=1)
Ent5.insert(0, "row 1, column 1")

Ent6 = Entry(window, bd=2, justify="center", fg="blue")
Ent6.grid(row=1, column=2)
Ent6.insert(0, "row 1, column 2")

Ent7 = Entry(window, bd=2, justify="center", fg="red")
...
Ent9 = Entry(window, bd=2, justify="center", fg="blue")
